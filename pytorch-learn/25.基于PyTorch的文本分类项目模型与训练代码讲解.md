#! https://zhuanlan.zhihu.com/p/555946030
# 25.基于PyTorch的文本分类项目模型与训练代码讲解

这次做一个实战项目，[IMDB Dataset of 50K Movie Reviews](https://www.kaggle.com/datasets/lakshmi25npathi/imdb-dataset-of-50k-movie-reviews)

代码包含了日志，模型保存等内容，可以作为代码模板参考。

下图来自于[Language Modeling with Gated Convolutional Networks](https://arxiv.org/pdf/1612.08083.pdf)
门卷积GCNN如图所示，可以看看这篇[文章](https://zhuanlan.zhihu.com/p/51212511)
![GCNN](https://pic4.zhimg.com/80/v2-d48b54b85dc1583f9b47824d5e3b325a.jpg)
